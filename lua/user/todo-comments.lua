...
todo_comments.setup {
    ...
    keywords = {
        ...
        TODO = { icon = icons.ui.Check, color = hint_blue, alt = { "TIP", "ToDo" } },
        HACK = { icon = icons.ui.Fire, color = warning_orange },
        WARN = { icon = icons.diagnostics.Warning, color = warning_orange, alt = { "WARNING", "XXX", "Warn" } },
        PERF = { icon = icons.ui.Dashboard, color = perf_purple,
            alt = { "OPTIM", "PERFORMANCE", "OPTIMIZE", "TEST", "Perf" } },
        NOTE = { icon = icons.ui.Note, color = note_green, alt = { "INFO", "Info" } },
    },
